...
ns = ns.dropna()
    ...
    # cross validation and apply LR2 machine learning techniques
...
## the results gives 0.795 of accuracy with std of 0.041 for 9 fold cross-validation.
## here is to optimize the best kfold for LR2 model.

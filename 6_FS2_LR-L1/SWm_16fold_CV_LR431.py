# Set work directory
import os
os.chdir("/Users/Zoey/Library/CloudStorage/OneDrive-UniversityofFlorida/PhD_Coding/23_FS_LR-L1_16fold_ALL")
os.getcwd()
...
# Load data
sw = pd.read_csv ('SW904_LR-L1_413.csv', sep=',',encoding='utf-8')
ns = pd.read_csv ('NS318_LR-L1_413.csv', sep=',',encoding='utf-8')
sw = sw.dropna()
ns = ns.dropna()
